(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../Plugin", "../statusCode", "../RequestError"], factory);
    }
    ...
    var statusCode_1 = tslib_1.__importDefault(require("../statusCode"));
    ...
    var CorePlugin = /** @class */ (function (_super) {
        tslib_1.__extends(CorePlugin, _super);
        function CorePlugin() {
            ...
            if (!this.extraOptions.quiet && error && feedback) {
                ...
                if (error.response) {
                    ...
                    if (response) {
                        ...
                        var _statusMsg = statusCode_1.default[response.status];
                        if (_statusMsg) {

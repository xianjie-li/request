...
export declare type MixOpt<OPTIONS extends BaseRequestOptions> = OPTIONS & {
...
export interface Options<OPTIONS extends BaseRequestOptions> {
    ...
    messageField?: string;
    /** 配置反馈方式 */
    feedBack?(message: string, status: boolean, extraOption: ExtraOptions, requestConfig: MixOpt<OPTIONS>): void;
...
export interface Request<OPTIONS> {
    <Data = any>(url: string, options?: MixOpt<OPTIONS>): Promise<readonly [Error | RequestError | null, Data | null]>;
}
/**
 * request配置必须遵循的一些字段名
